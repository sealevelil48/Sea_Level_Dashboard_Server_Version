...
def get_latest_station_data(end_date=None):
    ...
    if not DATABASE_AVAILABLE or not engine:
        ...
        return [
            {"Station": "Acre", "name": "Acre", "x": 206907, "y": 758285, "longitude": 35.070281, "latitude": 32.919482, "latest_value": 0.478, "last_update": "2024-09-02 00:00"},
            {"Station": "Ashdod", "name": "Ashdod", "x": 166075, "y": 637753, "longitude": 34.640522, "latitude": 31.831303, "latest_value": 0.512, "last_update": "2024-09-02 00:00"},
            {"Station": "Ashkelon", "name": "Ashkelon", "x": 158044, "y": 621218, "longitude": 34.556778, "latitude": 31.681832, "latest_value": 0.445, "last_update": "2024-09-02 00:00"},
            {"Station": "Eilat", "name": "Eilat", "x": 191654, "y": 379381, "longitude": 34.917692, "latitude": 29.501767, "latest_value": 0.389, "last_update": "2024-09-02 00:00"},
            {"Station": "Haifa", "name": "Haifa", "x": 199451, "y": 748207, "longitude": 34.990936, "latitude": 32.828428, "latest_value": 0.523, "last_update": "2024-09-02 00:00"},
            {"Station": "Yafo", "name": "Yafo", "x": 176505, "y": 662250, "longitude": 34.74964, "latitude": 32.052552, "latest_value": 0.467, "last_update": "2024-09-02 00:00"}
        ]
    ...
    try:
        ...
        with engine.connect() as connection:
            ...
            if not stations:
                ...
                # Return fallback data with DB timestamp format (00:00)
                return [
                    {"Station": "Acre", "name": "Acre", "x": 206907, "y": 758285, "longitude": 35.070281, "latitude": 32.919482, "latest_value": 0.478, "last_update": "2024-09-02 00:00"},
                    {"Station": "Ashdod", "name": "Ashdod", "x": 166075, "y": 637753, "longitude": 34.640522, "latitude": 31.831303, "latest_value": 0.512, "last_update": "2024-09-02 00:00"},
                    {"Station": "Ashkelon", "name": "Ashkelon", "x": 158044, "y": 621218, "longitude": 34.556778, "latitude": 31.681832, "latest_value": 0.445, "last_update": "2024-09-02 00:00"},
